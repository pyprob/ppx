...
public final class ProtocolTensor extends Table {
  ...
  public static ProtocolTensor getRootAsProtocolTensor(ByteBuffer _bb, ProtocolTensor obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createProtocolTensor(FlatBufferBuilder builder,
      int dataOffset,
      int shapeOffset) {
  ...
  public static int endProtocolTensor(FlatBufferBuilder builder) {
